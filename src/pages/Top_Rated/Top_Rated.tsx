...
const TopRated = () => {
  ...
  // Función de petición GET a la API de películas mejor valoradas
  const fetchTopRatedMovies = async (pageNumber) => {
    const {
      data: { results,total_pages },
    } = await axios.get(`${API_URL}/movie/top_rated?${LANG}&page=${pageNumber}`, {
      params: {
        api_key: API_KEY,
      },
    });
